...
export function PaymentFailedEmail({ name, cohortName, updatePaymentUrl }: Props) {
  return (
    <Html lang="pt-BR">
      <Head />
      <Preview>Problema no pagamento da sua renovação em {cohortName}</Preview>
      <Body style={styles.main}>
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            <Text style={styles.monoLabel}>ATENÇÃO</Text>
            <Heading style={styles.heading}>Problema no pagamento</Heading>
            <Text style={styles.body}>
              Olá, {name}. Não foi possível processar o pagamento de renovação
              para <strong style={styles.strong}>{cohortName}</strong>.
            </Text>
            <Text style={styles.body}>
              Sua matrícula está temporariamente suspensa. Atualize seu método
