...
export function PaymentApprovedEmail({ name, cohortName, dashboardUrl }: Props) {
  return (
    <Html lang="pt-BR">
      <Head />
      <Preview>Pagamento confirmado — acesso liberado</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>Acesso liberado!</Heading>
          <Text style={text}>
            Olá, {name}. Seu pagamento para <strong>{cohortName}</strong> foi confirmado.
            Você já pode acessar todo o conteúdo da turma.
          </Text>
...
PaymentApprovedEmail.PreviewProps = {
  name: 'João',
