        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-white/60 mb-10 text-base leading-relaxed">
              ...
              <span className="text-[#FF4400] font-mono">/team-os</span> — a skill que orquestra tudo.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">1</span>
                  <h3 className="text-lg font-semibold text-white">Pré-requisitos</h3>
                </div>
                <ul className="space-y-2 text-sm text-white/70 mb-4">
                  <li className="flex items-start gap-2">
                    <svg className="h-4 w-4 text-[#FF4400] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">2</span>
                ...
                <pre className="bg-black/50 p-4 text-sm text-green-400 overflow-x-auto rounded mb-4">
...
cd /caminho/do/seu-projeto`}</code>
                ...
                <pre className="bg-black/50 p-4 text-sm text-green-400 overflow-x-auto rounded mt-2">
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">3</span>
...
source ~/.zshrc`}</code>
                ...
                <pre className="bg-black/50 p-4 text-sm text-green-400 overflow-x-auto rounded">
...
# Deve retornar: 1`}</code>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">4</span>
...
claude`}</code>
              ...
              {/* Step 5 — /team-os */}
              <div className="glass-card p-6 border border-[#FF4400]/20">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">5</span>
                  <h3 className="text-lg font-semibold text-white">
                    Invocar o <span className="text-[#FF4400]">/team-os</span>
                  </h3>
                </div>
                ...
                <pre className="bg-black/50 p-4 text-sm text-green-400 overflow-x-auto rounded mb-5">
                  <code>{`/team-os`}</code>
                </pre>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { state: 'IN_PROGRESS', color: 'text-green-400', desc: 'Stories ativas detectadas → retoma trabalho automaticamente (*resume)' },
                    { state: 'READY', color: 'text-[#FF4400]', desc: 'Smart-memory OK, sem stories → pede objetivo para formar novo time' },
                  ].map(({ state, color, desc }) => (
                    <div key={state} className="flex items-start gap-3 bg-black/30 p-3">
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">6</span>
                ...
                <pre className="bg-black/50 p-4 text-sm text-white/70 overflow-x-auto rounded">
...
└── ops/
    └── teams-log.md      ← registro dos times formados`}</code>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">7</span>
                ...
                <pre className="bg-black/50 p-4 text-sm text-green-400 overflow-x-auto rounded mb-3">
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">8</span>
                ...
                <p className="text-sm text-white/50 mb-3">
                  O <span className="font-mono">/team-os</span> seleciona os agentes certos para o objetivo, forma o Agent Team e cada teammate recebe as tasks automaticamente. Acompanhe com <span className="font-mono text-[#FF4400]">Shift+Tab</span> para ver todos os agentes ativos em paralelo.
                </p>
              </div>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-5">
                  <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FF4400] text-white text-xs font-bold font-mono flex-shrink-0">9</span>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={cmd} className="flex items-start gap-3 bg-black/30 p-3">
                      <span className="font-mono text-xs text-[#FF4400] flex-shrink-0 mt-0.5 min-w-[220px]">{cmd}</span>
                      <span className="text-sm text-white/60">{desc}</span>
                    </div>
                  ))}
                </div>
      ...
      <section className="py-20 bg-[#08080C]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 mb-10 max-w-2xl text-base leading-relaxed">
            Cada squad tem agentes com papéis, ferramentas e autoridades distintas. O <span className="text-[#FF4400] font-mono">/team-os</span> monta o subconjunto mínimo necessário para cada objetivo.
          </p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="inline-flex items-center justify-center bg-[#FF4400]/10 p-2.5 text-[#FF4400]">
              ...
              <ul className="space-y-1.5 text-sm text-white/60">
                {[
                  ...
                  <li key={a} className="flex items-start gap-2">
                    <span className="text-[#FF4400] mt-1 flex-shrink-0">›</span>
                    <span>{a}</span>
                  </li>
                ))}
              </ul>
