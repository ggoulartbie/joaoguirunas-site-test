...
export const metadata: Metadata = {
  title: 'Vercel Deploy com Claude Code — CI/CD',
  description:
    'Deploy automatizado com a Vercel via Claude Code. CI/CD, preview deployments e domínios custom configurados pelo terminal para colocar projetos web no ar.',
  openGraph: {
...
const features = [
  {
    title: 'Auto Deploy',
    description:
      'Deploy automático a cada push no repositório. Zero configuração para frameworks como Next.js, Astro e Nuxt.',
  ...
  },
  {
    title: 'Preview URLs',
    description:
      'URLs de preview únicas para cada branch e PR. Revise mudanças visualmente antes de mergear.',
  ...
  },
  {
    ...
    description:
      'Configure domínios personalizados com SSL automático. DNS management integrado e certificados gratuitos.',
  ...
  },
  {
    ...
    description:
      'Execute código no edge, próximo ao usuário. Latência mínima para APIs, middleware e server-side rendering.',
  ...
  },
  {
    title: 'Analytics',
    description:
      'Web analytics integrado com métricas de performance. Core Web Vitals, traffic e experiência do usuário em tempo real.',
  ...
  },
  {
    title: 'Zero-Config',
    description:
      'Detecção automática de framework e configuração. Funciona com Next.js, Astro, Remix, SvelteKit e mais.',
...
const longDescription = [
  'Vercel Deploy é uma skill de integração que conecta o Claude Code ao ecossistema Vercel para deploy automatizado de projetos web. A cada push no repositório, o deploy acontece automaticamente com zero configuração para frameworks como Next.js, Astro, Remix e SvelteKit.',
  'Preview deployments são gerados para cada branch e pull request, permitindo revisão visual de mudanças antes do merge. Cada preview tem sua própria URL única, facilitando QA, feedback de stakeholders e testes de aceitação em ambiente real.',
  'Com edge functions, o código roda próximo ao usuário final com latência mínima. Analytics integrado monitora Core Web Vitals, performance e experiência do usuário em tempo real. Custom domains com SSL automático completam o stack de produção.',
];
...
export default function VercelPage() {
  return (
    <SkillPage
      title="Vercel Deploy"
      description="Deploy automatizado com Vercel. CI/CD, preview deployments e domínios custom para projetos web."
