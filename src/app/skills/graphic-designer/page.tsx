...
export const metadata: Metadata = {
  title: 'Graphic Designer com IA no Claude Code',
  description:
    'Crie thumbnails, posts de social media, banners e apresentações com Claude Code aplicando princípios de design CRAP e Gestalt. Visual profissional via prompt.',
  openGraph: {
...
const features = [
  {
    ...
    description:
      'Organização visual que guia o olho do espectador. Tamanho, cor, contraste e posição usados estrategicamente.',
  ...
  },
  {
    title: 'Typography',
    description:
      'Seleção e combinação tipográfica com regras de peso, tamanho e espaçamento. Legibilidade em qualquer formato.',
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12"/>',
  },
  {
    title: 'Color Theory',
    description:
      'Paletas de cores baseadas em teoria cromática. Harmonia, contraste e acessibilidade WCAG aplicados automaticamente.',
  ...
  },
  {
    title: 'Layout Design',
    description:
      'Layouts com grid system, alinhamento e espaçamento consistente. Princípios CRAP (Contraste, Repetição, Alinhamento, Proximidade).',
  ...
  },
  {
    ...
    description:
      'Manutenção de identidade visual com paleta, fontes e elementos gráficos consistentes entre peças.',
  ...
  },
  {
    ...
    description:
      'Decisões de design baseadas em pesquisa de Gestalt, neurociência visual e dados de engajamento.',
...
const longDescription = [
  'Graphic Designer é uma skill para Claude Code que aplica princípios profissionais de design na criação de thumbnails, social media, banners, apresentações e qualquer asset visual. Ela usa os princípios CRAP (Contraste, Repetição, Alinhamento, Proximidade) e leis de Gestalt para decisões fundamentadas.',
  'A skill domina hierarquia visual, tipografia, teoria de cores e layout design. Cada peça criada segue regras de acessibilidade WCAG, harmonia cromática e legibilidade em diferentes tamanhos de tela. Nada é arbitrário — cada escolha de cor, fonte e espaçamento tem justificativa técnica.',
  'Para manter brand consistency, a skill trabalha com paletas definidas, famílias tipográficas e elementos gráficos recorrentes. Ela também incorpora insights de neurociência visual e dados de engajamento para decisões que não são só bonitas, mas eficazes em reter atenção e comunicar mensagem.',
];
...
export default function GraphicDesignerPage() {
  return (
    <SkillPage
      ...
      description="Design de thumbnails, social media, banners e apresentações com princípios CRAP e Gestalt."
      category="Skills"
            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-white/60 mb-3 text-sm">
                  Ou clone o repositório de squads:
                </p>
                <div className="bg-[#16161a] border border-white/10 p-4 font-mono text-sm text-[#FF3A0E]">
              ...
              <p className="text-white/60 text-sm">
                ...
                para ter acesso a todas as capacidades de design com princípios CRAP e
                Gestalt.
              </p>
            </div>
          </div>
