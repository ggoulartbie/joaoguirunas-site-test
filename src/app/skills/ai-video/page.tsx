...
export const metadata: Metadata = {
  title: 'Geração de Vídeos com IA via Claude Code',
  description:
    'Gere vídeos com IA usando 40+ modelos como Veo 3.1, Seedance, Wan 2.5 e Grok direto do terminal com Claude Code e a CLI da inference.sh. Tudo via prompt.',
  openGraph: {
...
const features = [
  {
    title: 'Text-to-Video',
    description:
      'Gere vídeos a partir de prompts de texto usando modelos como Veo 3.1, Seedance 1.1, Wan 2.5 e Kling 2.1.',
  ...
  },
  {
    ...
    description:
      'Anime imagens estáticas em vídeos dinâmicos. Transforme qualquer foto ou ilustração em movimento.',
  ...
  },
  {
    title: 'Lipsync',
    description:
      'Sincronize lábios de personagens com áudio. Perfeito para criar talking heads e apresentações.',
  ...
  },
  {
    ...
    description:
      'Crie avatares de IA realistas para vídeos. Ideal para conteúdo de marketing e apresentações.',
  ...
  },
  {
    title: 'Upscaling',
    description:
      'Aumente a resolução dos seus vídeos com IA. De 480p para 4K mantendo qualidade e detalhes.',
  ...
  },
  {
    title: 'Foley Sound',
    description:
      'Gere efeitos sonoros automaticamente para seus vídeos. Áudio sincronizado com a ação visual.',
...
const longDescription = [
  'AI Video Generation é uma skill que conecta o Claude Code ao inference.sh, dando acesso a mais de 40 modelos de geração de vídeo via CLI. Com um único comando, você gera vídeos usando Veo 3.1 do Google, Seedance 1.1, Wan 2.5, Kling 2.1, Grok Video e muitos outros.',
  'A skill suporta múltiplos modos de geração: text-to-video para criar do zero, image-to-video para animar fotos, lipsync para sincronizar fala, e avatar generation para criar apresentadores virtuais. Tudo direto do terminal, sem precisar abrir interfaces web.',
  'Para produção de conteúdo em escala, a combinação de upscaling com foley sound permite gerar vídeos de alta qualidade com áudio sincronizado automaticamente. Ideal para social media, ads, e conteúdo educacional.',
];
...
export default function AiVideoPage() {
  return (
    <SkillPage
      ...
      description="Gere vídeos com IA usando 40+ modelos. Veo 3.1, Seedance, Wan 2.5, Grok e mais via inference.sh CLI."
      category="Skills"
        ...
        <div className="mx-auto max-w-6xl px-6 sm:px-10 lg:px-[140px]">
          <div className="max-w-3xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-white/60 mb-3 text-sm">
                  Ou instalar skill específica de vídeo:
                </p>
                <div className="bg-[#16161a] border border-white/10 p-4 font-mono text-sm text-[#FF3A0E]">
              ...
              <p className="text-white/60 text-sm">
                Após a instalação, gere vídeos direto do terminal com{' '}
