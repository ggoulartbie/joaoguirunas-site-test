...
export const MODULOS_PRESENCIAIS: Modulo[] = [
  {
    ...
    href: '/mentoria/modulos/o-que-e-possivel',
  },
  {
    ...
    href: '/mentoria/modulos/fundamentos-claude-code',
  },
  {
    ...
    href: '/mentoria/modulos/centro-treinamento',
  },
  {
    ...
    href: '/mentoria/modulos/setup-instalacao',
  },
];
        ...
        <nav className="mt-16 border-t pt-8" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            {prev ? (
              ...
              <Link href="/mentoria/modulos" className="group flex flex-col gap-1">
                <span className="text-[10px] tracking-[0.22em] uppercase text-white/35" style={{ fontFamily: MONO }}>
                  ← Início
                </span>
