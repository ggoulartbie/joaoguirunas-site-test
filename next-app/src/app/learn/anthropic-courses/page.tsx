...
export const metadata: Metadata = {
  ...
  description:
    'Curadoria dos 13 cursos gratuitos da Anthropic. Aprenda a construir com Claude.',
...
const features = [
  {
    ...
    description:
      'Fundamentos e técnicas avançadas de construção de prompts efetivos para Claude.',
  ...
  },
  {
    title: 'Tool Use',
    description:
      'Como integrar Claude com ferramentas externas e APIs para expandir capacidades.',
  ...
  },
  {
    ...
    description:
      'Construção de sistemas de agentes autônomos que executam tarefas complexas.',
  ...
  },
  {
    ...
    description:
      'Retrieval Augmented Generation e uso de embeddings para contexto dinâmico.',
  ...
  },
  {
    title: 'Multimodal',
    description:
      'Processamento de imagens, PDFs e outros formatos além de texto.',
  ...
  },
  {
    ...
    description:
      'Boas práticas de segurança, alinhamento e uso responsável de IA.',
...
const longDescription = [
  'Curadoria completa dos 13 cursos gratuitos da Anthropic para aprender a construir com Claude. De prompt engineering básico até sistemas de agentes complexos.',
  'Os cursos cobrem fundamentos de LLMs, técnicas avançadas de prompting, integração de ferramentas, RAG, processamento multimodal, e boas práticas de segurança.',
  'Todo o conteúdo é oficial da Anthropic e atualizado regularmente. Ideal para desenvolvedores e profissionais que querem dominar o ecossistema Claude.',
];
...
export default function AnthropicCoursesPage() {
  return (
    <SkillPage
      ...
      features={features}
      primaryLink="https://github.com/anthropics/courses"
      primaryLabel="Ver Cursos no GitHub"
      author="Anthropic"
